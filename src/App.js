...
export default function App() {
  ...
  // Track refresh state to force-remount components
  ...
  // Integrated Navigation Handler
  const handleNavigation = (pageId) => {
    if (currentPage === pageId) {
      // If user clicks the current page, increment key to refresh/remount
